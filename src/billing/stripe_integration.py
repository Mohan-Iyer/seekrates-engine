...
class StripeIntegration:
    ...
    def __init__(self):
        ...
        # CP price IDs registered as Railway env vars (INDRA-172, 2026-04-02).
        # Mapping to SE tier names deferred — D-SE-27 replacement CCI required.
        # DEPRECATED-PENDING: D-SE-27 (Oracle-unconditional CP auth).
        # CP vars: STRIPE_PRICE_CP_PRO_MONTHLY, STRIPE_PRICE_CP_PRO_ANNUAL,
        #          STRIPE_PRICE_CP_AGENCY_MONTHLY, STRIPE_PRICE_CP_AGENCY_ANNUAL,
        #          STRIPE_PRICE_CP_PAYG_CREATE, STRIPE_PRICE_CP_PAYG_RESCUE,
        #          STRIPE_PRICE_CP_PAYG_AGENCY_DEMO
